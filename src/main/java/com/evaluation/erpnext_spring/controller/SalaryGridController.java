...
import com.evaluation.erpnext_spring.service.SalaryGridService;

import jakarta.servlet.http.HttpSession;

@Controller
@RequestMapping("/grids")
public class SalaryGridController {

    @Autowired
    private SalaryGridService salaryGridService;
    ...
    public ModelAndView showSalaryGridForm(HttpSession session) {
        ...
        try {
            ...
            modelAndView.addObject("salaryGridDTO", new SalaryGridDto());
    ...
    public ModelAndView createSalaryGrid(HttpSession session,
                                         @ModelAttribute SalaryGridDto salaryGridDTO,
